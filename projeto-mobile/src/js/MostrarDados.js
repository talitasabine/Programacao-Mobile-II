        ...
        <View style={styles.container}>
            ...
            {dadosSalvos && (
                <>
                    ...
                    <Text style={styles.text}>Celular: {dadosSalvos.celular}</Text>
                    <Text style={styles.text}>Email: {dadosSalvos.email}</Text>
                    <Text style={styles.text}>Senha: {dadosSalvos.senha}</Text>
                </>
            )}
        </View>
    );
